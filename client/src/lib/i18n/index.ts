...
const messages = {
  en: {
    ...
    recipes: {
      ...
      loadingHint: "More recipes will load as you scroll.",
      loadingMore: "Loading more recipes...",
      loadMoreFailed: "Could not load more recipes.",
      ...
      detail: {
        ...
        actionFailed: "Could not complete that action right now.",
        ...
        commentCreateFailed: "Could not post the comment.",
        commentUpdateFailed: "Could not update the comment.",
        commentDeleteFailed: "Could not remove the comment.",
    ...
    shoppingLists: {
      ...
      loadingHint: "More lists will load as you scroll.",
      loadingMore: "Loading more lists...",
      loadMoreFailed: "Could not load more shopping lists.",
      noListsTitle: "No shopping lists yet",
      noListsDescription:
  ...
  ru: {
    ...
    recipes: {
      ...
      loadingHint: "Новые рецепты подгрузятся по мере прокрутки.",
      loadingMore: "Подгружаем еще рецепты...",
      loadMoreFailed: "Не удалось подгрузить еще рецепты.",
      ...
      detail: {
        ...
        actionFailed: "Сейчас не удалось выполнить это действие.",
        overviewTitle: "Кратко",
        overviewSubtitle: "Статус: {status} · Обновлен {date}",
        jumpToComments: "К комментариям",
        ...
        commentCreated: "Комментарий опубликован.",
        commentUpdated: "Комментарий обновлен.",
        commentDeleted: "Комментарий удален.",
        commentCreateFailed: "Не удалось отправить комментарий.",
    ...
    shoppingLists: {
      ...
      loadingHint: "Новые списки подгрузятся по мере прокрутки.",
      loadingMore: "Подгружаем еще списки...",
      loadMoreFailed: "Не удалось подгрузить еще списки покупок.",
      noListsTitle: "Списков покупок пока нет",
      noListsDescription:
